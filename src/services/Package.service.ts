...
const examples: TypedPackageStub[] = exampleUrl ? [
  ...
  { title: 'StoriedApes', name: 'ownable-storiedApes', description: 'Storied Apes Legacy', stub: true },
  {title: 'Flipped apes', name: 'ownable-flippedApes', description: 'Vertical flipped apes', stub: true},
] : [];
