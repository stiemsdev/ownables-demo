...
const examples: TypedPackageStub[] = exampleUrl ? [
  ...
  { title: 'Storied apes', name: 'ownable-storied_apes', description: 'Storied Apes Legacy', stub: true },
  {title: 'Flipped apes', name: 'ownable-flipped_apes', description: 'Vertical flipped apes', stub: true},
] : [];
