...
const CONTRACT_NAME: &str = "crates.io:ownable-pixel";
...
pub fn instantiate(
    ...
    let ownable_info = OwnableInfo {
        ...
        ownable_type: Some("pixel".to_string()),
    };
    ...
    let metadata = Metadata {
        ...
        image_data: None,
        external_url: None,
        description: Some("First pixel ape".to_string()),
        name: Some("Pixel Ape".to_string()),
